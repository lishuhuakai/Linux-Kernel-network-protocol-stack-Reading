...
/* tcp_options_received结构体主要用于保存接收到的tcp选项信息 */
...
/*	PAWS/RTTM data	*/
    ...
    /* saw_tstamp用于标识最近收到的tcp报文中是否存在时间戳选项 */
	u16 	saw_tstamp : 1,	/* Saw TIMESTAMP on last packet		*/
	/* tstamp_ok用于标识tcp连接是否启用时间戳选项. */
		tstamp_ok : 1,	/* TIMESTAMP seen on SYN packet		*/
		dsack : 1,	/* D-SACK is scheduled			*/
		/* wscale_ok标志接收方是否支持窗口扩大因子 */
...
/* RTT measurement */
	...
	u32	packets_out;	/* Packets which are "in flight"	*/
                        /* 已经发送了,但是还没有收到确认的报文的数目,像还在坐飞机一样 */
 ...
 */
    ...
    /* 记录SND.UNA与sack选项中目前接收方接收到的段中最高序号段之间的段数,FACK算法用
	...
	struct tcp_sack_block recv_sack_cache[4]; /* 用于记录上一次的sack对 */
