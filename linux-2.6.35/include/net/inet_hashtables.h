...
struct inet_hashinfo {
	 ...
	 */
	struct inet_ehash_bucket	*ehash; /* 除了LISTEN状态的传输控制块都存储在这个hash之中 */
	 ...
	 */
	struct inet_bind_hashbucket	*bhash; /* 用来存储已绑定端口的信息 */
	 ...
	 */
	struct inet_listen_hashbucket	listening_hash[INET_LHTABLE_SIZE] /* 用来存储LISTEN状态的传输控制块 */
